...
clauses = [
    ...
    "If the contract is not terminated, the contract is automatically renewed with the same billing period.",
    "The sending of emails is inadmissible if it is a mass-mailing to recipients without their consent and/or if it is a promotional email and consent of the recipient is not given even though this is required (hereafter referred to as spam).",
    "The place of jurisdiction for demands resulting from differences between the parties to a contract, in particular about the conclusion of a contract, its execution or its termination - insofar as the customer is a general merchant, a corporate body under public law, or a separate estate under public law - is Hanover, Germany.",
    # Free Music Archive
    ...
    "You will not post spam, junk mail, or chain letters on the Site.",
    "Failure of the Free Music Archive to pursue a violation of a specific provision of the Terms does not imply a waiver of our right to pursue and act on violations of the Terms.",
    # Mozilla
    ...
    "Note that certain features of our products and services may not function properly without the aid of cookies.",
    "We may need to change this policy and our notices. The updates will be posted online. If the changes are substantive, we will announce the update through Mozilla's usual channels for such announcements such as blog posts and forums.",
    "Mozilla has implemented third-party technology, Google’s Invisible reCAPTCHA, that operates in the background on some of our websites in order to identify fraudulent activity.",
    "When we receive requests like this, we'll only release your personal information if we have a good faith belief that the law requires us to do so. Nothing in this policy is intended to limit any legal defenses or objections that you may have to a third party's request to disclose your information.",
    # Discord
    ...
    "We may decide to update these terms: (1) to reflect changes to our services or our business, (2) for legal or regulatory reasons, (3) to prevent abuse on or of our services, or (4) to better protect or serve users of our services. If these changes materially affect your Discord use or your legal rights, we’ll give you reasonable advance notice (unless the updates are urgent). If you continue to use our services after the changes have taken effect, it means that you agree to the changes.",
    "Subject to applicable law, we reserve the right to suspend or terminate your account and/or your access to some or all of our services with or without notice, at our discretion for the following reasons: You breach these terms, our policies, or additional terms that apply to specific products.We’re required to do so to comply with a legal requirement or court order. We reasonably believe termination is necessary to prevent harm to you, us, other users, or third parties. Your account has been inactive for more than two years. Continuing to allow your account to be active, giving you access to some or all services, or hosting your content creates risk for Discord, other users, or third parties. However, we will give you advance notice if reasonable to do so or required by applicable law.",
    ...
    "However, please note that if you do this, you may not be able to access the full functionality of our websites.",
    ...
    "Valve also processes anonymous data, aggregated or not, to analyze and produce statistics related to the habits, usage patterns, and demographics of customers as a group or as individuals.",
...
correct_labels = ["good","good","good","good","good","good","good","good","neutral","neutral","neutral",
"bad","good","neutral","neutral",
"bad","bad","bad","bad","bad","good","good","good","good","neutral","neutral","neutral","neutral",
"bad","bad","bad","bad","bad","good","neutral","neutral","neutral",
"very bad","bad","bad","bad","bad","bad","bad","bad","bad","good","good","good","neutral","neutral","neutral","neutral"]
