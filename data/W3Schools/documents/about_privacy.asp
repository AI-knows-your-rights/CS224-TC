...
<link rel="stylesheet" href="/lib/topnav/main.css?v=1.0.39">
...
<script src="/lib/uic_prov.js?v=1.0.3"></script>
...
<a target="_top" class="no-checkmark" href="default.asp">About W3Schools</a>
<a target="_top" class="no-checkmark" href="about_copyright.asp">About Terms</a>
<a target="_top" class="no-checkmark" href="about_privacy.asp">About Privacy</a>
<a target="_top" class="no-checkmark" href="about_cookies.asp">About Cookies</a>
...
<a class="w3-right w3-btn" href="about_cookies.asp">Next &#10095;</a>
</div>
<hr>
<h2>Introduction</h2>
<p>This Privacy Policy explains how we collect, use, and share your personal information when you use www.w3schools.com (the “Website”) and or our product and or our services (the “Services”).</p>
<p>We categorize our users as either "Customers" or "Free Users":</p>
<ul>
  <li><strong>Customers</strong> are users who have entered into an agreement with us or our resellers, either alone or with others, to access ad-free paid Services</li>
  <li><strong>Free Users</strong> use the Website and the Services for free</li>
</ul>
<p>When we refer to "Users" without specifying Customers or Free Users, we mean both groups.</p>
<p>By using or accessing the Website and the Services in any way, you agree to follow the practices and policies outlined in this Privacy Policy.</p>
<hr>
<h2>About W3Schools</h2>
<p>W3Schools is an online platform for learning web development and programming skills, offering tutorials, courses, certifications and various subscription plans. Our educational resources and interactive tools enable users to learn programming languages, build projects, track their progress and practice coding through exercises and quizzes. We fund the Website by showing adverts to our Free Users as you browse the Website.</p>
<ol type="1">
  <li>Visit the Website</li>
  <li>Use the Services</li>
  <li>Interact with us in any way, such as by email requests, receiving support or by filling out a form (collectively "Support")</li>
</ol>
<hr>
<h2 id="informationwecollect">Information We Collect</h2>
<p>We collect information about you based on how you interact with us, your choices, the products and features you use, your location, in accordance with applicable laws. This information comes either directly from you or automatically through your use of the Services.</p>
<h3>Information That You Provide Directly</h3>
<p>We collect the following information when you use the Website and or the Services.</p>
<ul>
  <li><strong>Contact Information:</strong> When you register, inquire about, or purchase our Services, participate in our marketing activities, or seek support, we collect your contact details. This includes your full name, email address, phone number, and location.</li>
  <li><strong>Account Information:</strong> To create, update, or manage your account on the Website, we collect information like your email address, full name and phone number.</li>
  <li><strong>Transactional Information:</strong> We gather payment and transaction details related to your use of the Services, such as encrypted payment card data and billing address.</li>
  <li><strong>Support and Troubleshooting Information:</strong> If you contact us for Support, we collect information about your preferences and any further details you provide. This includes messages, chat content and attachments, which help us assist you and comply with legal obligations.</li>
  <li><strong>Voluntary Information:</strong> Any other information you choose to provide, such as profile updates or feedback on your experience with the Services. By providing this information, you confirm that you own or have permission to share it.</li>
</ul>
<h3>Information from Sub-Processors</h3>
<p>We receive information about you from our sub-processors who support our business operations. We use this information only for the purposes described in this policy.</p>
<h3>Information We Automatically Collect</h3>
<p>When you use the Website and or the Services, we automatically collect certain information about you, your device, and how you interact with us as follows:</p>
<ul>
  <li><strong>Telemetry Information.</strong> We collect anonymous statistical data and aggregated, de-identified information about how you use the Website and or the Services.</li>
  <li><strong>Usage Information.</strong> We track how you interact with the Website and or the Services. This includes clicks, pages viewed, searches, the web browser used, page response times, errors, date and time stamps, request details (like speed and frequency), the site you came from ("referring page"), the site you visit after ours ("exit page"), and the time spent on the Website.</li>
  <li><strong>Device Information.</strong> We collect details about your device and how it interacts with the Website and or the Services. This includes browser type and settings, device type, screen size, operating system, model, language preferences, internet service provider, mobile network, push notification tokens, system activity, hardware settings, application version, and unique device identifiers like device type ID.</li>
  <li><strong>Service-Generated Information.</strong> We use data generated by your use of the Services, such as log files, diagnostics, capacity, and usage information, to determine storage needs, performance data from our servers, data settings, and system configurations, including your chosen privacy and security settings.</li>
  <li><strong>Cookies.</strong> We use cookies and similar tracking technologies to collect information from your browser, depending on your settings when using the Website and or the Services. As explained in our <a href="about_cookies.asp">Cookie Policy</a>, you can choose to delete or not accept our cookies.</li>
</ul>
<p>Sometimes, in compliance with applicable laws or our customer agreements, we combine the information we collect from different sources. For example, we might merge usage data with your feedback to improve the Services or inform you about relevant products.</p>
<hr>
<h2 id="howweuseinformation">How We Use Information</h2>
<p>We use your information to operate, improve, and maintain the Website and or the Services. Here are the ways we may use your information:</p>
<ul>
  <li><strong>Service Operation:</strong> We use your information to run and manage the Website and or the Services effectively. This includes operating, delivering, monitoring, and maintaining the Services, as well as troubleshooting and performing system maintenance and upgrades.</li>
  <li><strong>Product Development and Improvement:</strong> Your information helps us enhance the Services and develop new features. In addition we use your information to improve functionality, quality, and user experience.</li>
  <li><strong>Support:</strong> We use your information to provide customer assistance and technical support. This includes responding to your requests and inquiries to ensure a smooth experience with the Services.</li>
  <li><strong>Account Administration:</strong> We use your information to create and manage your account, complete transactions and send information such as purchase confirmations, receipts, and invoices.</li>
  <li><strong>Marketing and Promotional Activities:</strong> We use your information to personalize and enhance our marketing efforts. This includes developing and improving our marketing activities, analyzing trends and usage to provide content or features that match your interests and preferences and informing you about promotions, offers, updates, and new products or services that might interest you. We may send you newsletters, promotional emails, and other marketing communications tailored to your interactions with the Services.</li>
  <li><strong>Security:</strong> We use your information to protect you and the Services by seeking to detect and to investigate, prevent and or respond to potential threats, fraudulent transactions, unauthorized access and other malicious or illegal activities.</li>
  <li><strong>Legal, Safety, and Compliance:</strong> We use your information to comply with applicable laws and regulations. This involves meeting legal obligations, responding to court orders, and ensuring compliance with our terms and policies.</li>  
</ul>
<h3>For Free Users Only:</h3>
...
<hr>
<h2 id="howweshareyourinformation">How We Share Your Information</h2>
<p>We share your information to provide the Website and or the Services, comply with legal obligations, and as part of our regular business activities. We only share your information with those who need it to ensure that proper protections and agreements are in place.</p>
<ul>
  <li><strong>Sub-processors.</strong> To deliver the Website, the Services, and the Support, we share your information with our sub-processors (Overview). We only use sub-processors who have adequate contractual obligations in their standard agreements.They act based on our instructions and in line with our Privacy Policy, along with strict confidentiality and security measures. This includes:</li>
  <ul>
    <li><strong>Cloud Services:</strong> For data hosting, storage, and content delivery</li>
    <li><strong>Billing and Payments:</strong> To manage and process transactions</li>
    <li><strong>Customer Support:</strong> To address and resolve inquiries and support requests</li>
    <li><strong>Security Monitoring:</strong> To protect against fraud or illegal or harmful activities</li>
    <li><strong>Domain Registration:</strong> To register domains and manage related services for you</li>
    <li><strong>Analytics:</strong> To understand the performance and impact of our sites and services</li>
  </ul>
  <li><strong>For legal reasons.</strong> We will share your information if we believe it´s necessary to:</li>
  <ul>
    <li>Comply with applicable laws, regulations, legal processes, or governmental requests</li>
    <li>Enforce our agreements, Terms of Service and this Privacy Policy</li>
    <li>Detect, prevent, or address fraud, security or technical issues</li>
    <li>Protect the rights, property or safety of W3Schools, our Users, or the public</li>
  </ul>
  <li><strong>Business transfers.</strong> Suppose W3Schools is involved in a merger, acquisition, or sale of assets. In that case, we will continue to ensure the confidentiality of your information.</li>
</ul>
<h3>For Free Users Only:</h3>
<p>We share your information with partners who specialize in advertising across multiple websites. This sharing allows us to personalize your experience and provide you with targeted advertisements. We use sub-processors for this purpose; you can review their Privacy Policy here:</p>
<ul>
  <li>Google: <a href="https://policies.google.com/privacy?hl=en-US" target="_blank" >Privacy Policy</a></li>
  <li>Snigel: <a href="https://www.snigel.com/privacy-policy/" target="_blank" >Privacy Policy</a></li>
  <li>Buy Sell Ads: <a href="http://buysellads.com/privacy" target="_blank" >Privacy Policy</a></li>
  <li>Refinery 89: <a href="https://refinery89.com/privacy-policy/" target="_blank" >Privacy Policy</a></li>
</ul>
<p>Opting Out of Targeted Advertising:</p>
<ul>
  <li>W3Schools: <br><button class="ws-btn" onclick='adconsent("showGUI")'>Manage Consent</button></li>
  <li>Digital Advertising Alliance: <a href="http://optout.aboutads.info/" target="_blank" >http://optout.aboutads.info/</a></li> 
  <li>Your Online Choice: <a href="https://www.youronlinechoices.com/" target="_blank" >https://www.youronlinechoices.com.</a></li>
</ul>

<p><strong>Note:</strong> Opting out will not turn off ads; it will only stop them from being tailored to your interests.</p>
<hr>
<h2>Your Privacy Rights</h2>
<p>You have choices and rights regarding how we collect and use your information. Here's a summary of those options and how to exercise them:</p>
<ul>
  ...
  <li><strong>Account Preferences.</strong> You can update or correct certain account information at any time by logging into your account or contacting our support team. If you wish to delete your account, please follow the instructions provided in our <a href="https://support.w3schools.com/hc/en-gb/articles/14697964112402-How-can-I-delete-my-account" target="_blank">documentation.</a> We will retain certain information as described in the <a href="">How We Retain Your Information</a> section.</li>
  <li><strong>Managing Cookies and Tracking Technologies.</strong> You can manage your cookie preferences as described in the <a href="about_cookies.asp">Cookie Policy.</a></li>
  <li><strong>Managing Vendor Consent</strong> You may update and customise your Vendor Consent preferences at any time by clicking here:<br><button class="ws-btn" onclick='adconsent("showGUI")'>Manage Consent</button></li>
</ul>
<p>Depending on your location, you may have additional rights concerning your personal information. These rights vary by jurisdiction. To learn more about your specific rights, please see the <a href="#jurisdiction">Jurisdiction-Specific Information</a>.</p>
<hr>
<h2>How We Secure Information</h2>
<p>We use appropriate administrative, technical and physical safeguards to protect your information from unauthorized access, use, alteration, destruction, loss or disclosure. We also require our sub-processors, who handle your information on our behalf, to follow industry-standard security measures and meet their privacy and security obligations. However, we are not responsible for how our sub-processors handle privacy and security beyond the information we provide to or receive from them.</p>
<p> While we strive to protect your information, no security measures are entirely foolproof. If you have any questions about the security of the Website and the Services, please contact us using the information in the <a href="#contactus">Contact Us</a> section</p>
<hr>
<h2>How We Retain Your Information</h2>
<p>We retain your information for the minimum period necessary to fulfill our legal and contractual obligations, develop the Website and or the Services, resolve disputes, enforce our rights, and for legitimate business purposes such as tax or accounting requirements, as described in this policy and recommended by industry standards. When we no longer have a legitimate business need to process your information, we delete or anonymize it.</p>
<hr>
<h2>Third-Party Services</h2>
<p>The Website and the Services may contain links to or integrations with other websites or applications not operated or controlled by W3Schools. While we strive to avoid offensive or harmful content on these links, we are not responsible for the content, accuracy, or opinions expressed in these third-party services. We recommend you review each third-party service's terms and privacy policies before use to ensure they meet your compliance, privacy, and security requirements.</p>
<hr>
<h2>How We Transfer Information</h2>
<p>When you access or use the Website and or the Services or provide your information, you consent to process your information in the United States or Europe, where we operate. W3Schools may store, process, and transmit your information outside your country of residence to provide the Website and the Services. These countries may have different data protection laws. They might not offer the same level of protection as your country or the country where you initially provided the information. As applicable laws require, whenever we transfer your information, we take appropriate steps to protect it, including using standard contractual clauses or other legal mechanisms.</p>
<p>Our data privacy practices follow the EU-U.S. Data Privacy Framework (DPF). This means we comply with strict requirements for handling, storing, and sharing your information per the framework. You can read more about the framework <a href="https://www.dataprivacyframework.gov/Program-Overview" target="_blank">here</a></p>
<hr>
<h2>Minimum Age For Use Of Our Site</h2>
<p>By using the Website and or the Services, you confirm that you are at least 13 years old. The Services are not intended for anyone under the age of 13. If you are under the age of 13 or lack the authority to consent on behalf of users below this age (such as in an educational institution), you cannot use the Services.</p>
<hr>
<h2>Changes To This Privacy Policy</h2>
<p>We periodically review and update this Privacy Policy to reflect new Services or changes to our practices. You can see when this policy was last updated by referring to the "Last Update" date at the bottom of the policy. We encourage you to review the policy whenever you interact with us to stay informed about our privacy practices and how you can help protect your privacy.</p>
<hr>
<h2 id="contactus">Contact us</h2>
<p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:help@w3schools.com">help@w3schools.com</a></p>
<hr>
<h2 id="jurisdiction">Jurisdiction-Specific Information</h2>
<p>Depending on your location, certain data privacy rights and regulations may apply to you. Please refer to the sections below that are relevant to your jurisdiction:</p>
<h3>European Economic Area (EEA) and the United Kingdom (UK)</h3>
<p>This section applies to individuals located in the European Economic Area (EEA) and the United Kingdom (UK).</p>
<h4>Legal Bases for Processing Personal Data</h4>
<p>W3Schools processes your personal data only when we have a valid legal basis to do so. These include:</p>
<ul>
  <li><strong>Your Consent:</strong> When you have given us clear permission for specific purposes</li>
  <li><strong>Contractual Necessity:</strong> When the processing is required to fulfill a contract with you or to take steps before entering into a contract</li>
  <li><strong>Legitimate Interests:</strong> When processing is necessary for our legitimate business purposes, as long as your rights and freedoms are not overridden</li>
  <li><strong>Legal Obligations:</strong> When we must process your data to comply with applicable laws</li>
</ul>
<h4>International Data Transfer</h4>
<p>If your data is collected in Europe and stored outside of the European Economic Area (EEA), we ensure that your personal data is transferred with appropriate safeguards in place, such as Standard Contractual Clauses (SCCs)</p>
<h4>Your Rights</h4>
<p>If you are located in the European Union (EU) or Switzerland, you have the following rights regarding the personal data we hold about you:</p>
<ul>
  <li><strong>Right of Access:</strong> You have the right to request access to the personal data we process about you</li>
  <li><strong>Right to Rectification:</strong> You can request that we correct any inaccurate or incomplete personal data without undue delay</li>
  <li><strong>Right to Erasure:</strong> You can request the deletion of your personal data in certain circumstances, such as when it is no longer needed for the purposes for which it was collected</li>
  <li><strong>Right to Restriction:</strong> You can ask us to limit the processing of your personal data in specific situations, such as when you contest its accuracy, allowing us time to verify its correctness</li>
  <li><strong>Right to Data Portability:</strong> You can request a copy of your personal data in a structured, commonly used, and machine-readable format to transfer it to another organization</li>
  <li><strong>Right to Object:</strong> You have the right to object to the processing of your personal data for purposes based on our legitimate interests or for direct marketing</li>
</ul>
<p>If you wish to exercise any of these rights, please contact us using the details provided at the end of this Privacy Policy. We will respond to your request within 30 days. To process your request, we need to verify your identity. In some cases, applicable laws may require or allow us to decline your request. If this happens, we will explain the reason, subject to legal restrictions.</p>
<p>We retain personal data as needed to fulfill the purposes for which it was collected. This includes retaining information for our legitimate interests, such as complying with legal obligations, resolving disputes, preventing fraud, and enforcing agreements, even after a data subject request.</p>
...
<h3>United States</h3>
<p>This section applies to individuals in the U.S. and supplements our Privacy Notice to comply with U.S. Data Privacy Laws, including the California Consumer Privacy Act (CCPA).</p>
<h4>Data Collection, Use, and Sharing</h4>
<p>We collect and process personal information in order to provide the Website and the Services for our Users. The types of data we collect include:</p>
<ul>
  <li><strong>Personal Identifiers:</strong> Name, email address, and IP address</li>
  <li><strong>Customer Records:</strong> Billing address, subscription details, and payment information (processed securely and in encrypted form)</li>
  <li><strong>Commercial Information:</strong> Information about your purchases, subscriptions, and engagement with our services</li>
  <li><strong>Site Activity:</strong> Data about your interactions with the Website, such as pages visited, tutorials accessed, and performance metrics</li>
  <li><strong>Geolocation Data:</strong> Approximate location derived from your IP address</li>
</ul>
<p>For detailed information about what we collect and the sources of this data, see the <a href="#informationwecollect">Information We Collect</a> section. We collect and use this information to provide and improve our services, process transactions, ensure security, and for other business purposes outlined in the <a href="#howweuseinformation">How We Use Information</a> section.</p>
<p>We disclose the following categories of information for business or commercial purposes: personal identifiers, commercial information, site activity, geolocation data, and inferred insights. We work with trusted partners, including service providers, payment processors, and advertising platforms, to operate the Website and manage the Services. For further details, see the <a href="#howweshareyourinformation">How We Share Your Information</a> section.</p>
<h4>Your Privacy Rights</h4>
<p>Under U.S. Data Privacy Laws, you have the following rights regarding the personal information we collect:</p>
<ul>
  <li><strong>Right of Access:</strong> You can request access to and receive a summary of the personal information we have collected about you</li>
  <li><strong>Right to Know:</strong> You can request details about the categories and specific pieces of personal information we have collected in the last 12 months</li>
  <li><strong>Right to Rectify or Update:</strong> You can ask us to correct inaccurate or incomplete personal information. We recommend updating your information in your Account Settings first, if possible</li>
  <li><strong>Right to Delete or Limit:</strong> You can request that we delete your personal data or limit how we process it, in line with legal requirements</li>
  <li><strong>Right to Object:</strong> You can object to the processing of your personal data, as permitted by applicable laws</li>
  <li><strong>Right to Withdraw Consent:</strong> If you previously gave consent for us to process your data, you can withdraw it at any time</li>
  <li><strong>Right to Request Information:</strong> You can ask for details about how we collect, share, and disclose your personal information from the last 12 months</li>
  <li><strong>Right to Opt-Out of the Sale of Information:</strong> To opt out of the sale of your personal data</li>
  <li><strong>Right to Opt-Out of Sharing for Advertising:</strong> To opt out of sharing your data for targeted advertising</li>
  <li><strong>Right to Non-Discrimination:</strong> Exercising your privacy rights will not affect the services we provide to you</li>
  <li><strong>Right to Data Portability:</strong> You can request a copy of your personal information in a format that is easy to use and transfer to another organization, when feasible</li>
</ul>
<h4>Exercising Your Privacy Rights</h4>
<p>If you want to exercise any of these rights, contact us using the information in the <a href="#contactus">Contact Us</a> section. Clearly state which right you are exercising and provide details about your request. We will confirm receipt of your request within 10 days. To process your request, we will require information to verify your identity. If we cannot verify your identity, we will not be able to fulfill your request to access or delete your data.</p>
<p>To verify your identity, we require you to provide certain identifying information related to your account (i.e., user ID) or details about your recent interactions with us. We cannot process your request unless we verify your identity and confirm that the personal information relates to you or the individual you are acting on behalf of.</p>
<p>If you wish to authorize an agent to make a request on your behalf, you must provide a signed written permission authorizing them to act for you. Requests submitted by an agent without proper authorization will be denied.</p>
<p>We process verified requests within 45 days. However, certain requests cannot be fulfilled if they conflict with:</p>
<ul>
  <li>Federal, state, or local laws;</li>
  <li>Regulatory investigations;</li>
  <li>Subpoenas; or</li>
  <li>Legal claims or defenses.</li>
</ul>
<hr>
...
<table class="ws-table-all notranslate">
  ...
  <tbody>
    ...
    <tr>
      <td>Amazon</td>
      <td>USA</td>
      <td>Cloud Infrastructure for the Website and the Services</td>
    </tr>
    <tr>
      <td>Brevo</td>
      <td>EU</td>
    ...
    <tr>
      <td>Google, Inc</td>
      <td>USA</td>
      <td>Site analytics (web) and customer interactions (email)</td>
    </tr>
    <tr>
      <td>Paypal</td>
      <td>USA</td>
    ...
    <tr>
      <td>Revinova</td>
      <td>USA</td>
      <td>LMS platform - (Specific for AWS courses)</td>
    </tr>
    <tr>
      <td>Shopify</td>
      <td>USA</td>
    ...
    <tr>
      <td>Zendesk</td>
      <td>EU</td>
      <td>Customer support and CRM system</td>
    </tr>
  </tbody>
</table>
...
<script src="/lib/topnav/main.js?v=1.0.39"></script>
